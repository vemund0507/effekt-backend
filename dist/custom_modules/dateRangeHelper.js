...
module.exports = {
    ...
    createDateObjectsFromExpressRequest: function (req) {
        ...
        if (!req.query || !req.body)
            throw new Error("No query or body parameters, please include fromDate and toDate parameters in ISO_8601 format.");
        ...
        if (!moment(fromDate, moment.ISO_8601, true).isValid() || !moment(toDate, moment.ISO_8601, true).isValid())
