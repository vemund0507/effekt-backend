    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, con.query('SELECT * FROM Vipps_matching_rules WHERE PeriodFrom <= ? and PeriodTo >= ? ORDER BY precedence DESC', [periodStart, periodEnd])];
                case 1:
                    res = (_a.sent())[0];
...
module.exports = {
    getVippsParsingRules: getVippsParsingRules,
