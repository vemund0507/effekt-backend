...
function getDataOwners() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, con.query("SELECT * FROM Data_owner")];
                case 1:
                    res = (_a.sent())[0];
                    return [2 /*return*/, res.map(function (owner) { return ({
                            id: owner.ID,
                            name: owner.owner,
...
function getDefaultOwnerID() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, con.query('SELECT ID FROM Data_owner WHERE `default` = 1')];
                case 1:
                    res = (_a.sent())[0];
