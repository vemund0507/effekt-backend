    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, con.query("SELECT * FROM Payment")];
                case 1:
                    res = (_a.sent())[0];
                    if (res.length > 0) {
                        return [2 /*return*/, (mapDBpaymentToObject(res))];
                    }
                    else {
...
function mapDBpaymentToObject(dbPaymentObject) {
    return dbPaymentObject.map(function (method) {
        return {
            id: method.ID,
...
module.exports = {
    ...
    getPaymentMethodsByIDs: getPaymentMethodsByIDs,
