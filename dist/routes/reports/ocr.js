    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                try {
                    transactions = OCRparser.parse(data);
                }
                catch (ex) {
                    return [2 /*return*/, next(ex)];
                }
                return [4 /*yield*/, ocr.addDonations(transactions, metaOwnerID)];
            case 1:
                result = _a.sent();
                res.json({
                    status: 200,
